...
import org.example.questionbank.mapper.QuestionBankQuestionMapper;
...
//        }
    ...
    public QueryWrapper<QuestionBankQuestion> getQueryWrapper(
        ...
        String sortOrder = questionBankQuestionQueryRequest.getSortField();
    ...
    public void batchAddQuestionsToBank(List<Long> questionIdList, long questionBankId, User loginUser) {
        ...
        // 检查题目 id 是否存在
        List<Long> validQuestionIdList = questionService.listObjs(questionIdList);
